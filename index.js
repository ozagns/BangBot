...
Percobaan: ${f100.tries}/5`
            ...
            if (cmd === "!kerja" || cmd === "!work") {
                ...
                const jobs = [
                    ...
                    { text: "menjual gorengan panas", gaji: 1500 },
                    ...
                    { text: "menjadi kuli panggul pasar", gaji: 2500 },
                    { text: "mencuci piring di kondangan", gaji: 1200 },
                    { text: "menjadi joki skripsi", gaji: 8500 },
                    { text: "menguras empang tetangga", gaji: 3500 },
                    { text: "menjadi figuran di film azab", gaji: 4000 },
                    { text: "menambal ban bocor", gaji: 1800 },
                    { text: "menjadi pawang hujan (gagal)", gaji: 200 },
                    { text: "menjaga lilin (nguli beneran)", gaji: 4500 },
                    { text: "menjadi pembersih kaca gedung", gaji: 7500 },
                    { text: "mengumpulkan botol bekas", gaji: 1000 },
                    { text: "menjadi tukang parkir indomaret", gaji: 5500 },
                    { text: "ngasuh anak tetangga yang rewel", gaji: 2200 },
                    { text: "menjadi tester boba varian baru", gaji: 3000 },
                    { text: "berburu hantu buat konten tiktok", gaji: 6500 },
                    { text: "jualan cilok kuah", gaji: 2100 },
                    { text: "jadi admin pinjol", gaji: 9000 },
                    { text: "bersihin selokan komplek", gaji: 3200 },
                    { text: "cabutin rumput liar di makam", gaji: 2800 },
                    { text: "menjadi calo tiket bus", gaji: 4200 },
                    { text: "ngelap kaca bus antar kota", gaji: 1500 },
                    { text: "jadi tukang ojek payung", gaji: 800 },
                    { text: "ngitungin butiran beras", gaji: 100 },
                    { text: "jualan es teh jumbo", gaji: 2400 },
                    { text: "jadi tukang pangkas rambut", gaji: 5000 },
                    { text: "servis remote TV tetangga", gaji: 1200 },
                    { text: "bersihin kipas angin berdebu", gaji: 2300 },
                    { text: "jadi kurir paket nyasar", gaji: 3100 },
                    { text: "mencuci mobil mewah", gaji: 5500 },
                    { text: "jadi pelayan warteg", gaji: 2600 },
                    { text: "jualan pulsa keliling", gaji: 1900 },
                    { text: "menjadi satpam komplek", gaji: 4800 },
                    { text: "nyari kutu kucing oren", gaji: 1400 },
                    { text: "jadi tukang urut keliling", gaji: 3800 },
                    { text: "ngasur tumpukan jerami", gaji: 1100 },
                    { text: "jualan bakso boraks (boongan)", gaji: 3000 },
                    { text: "jadi pengamen suara fals", gaji: 600 },
                    { text: "bersihin kandang buaya", gaji: 9500 },
                    { text: "jadi sales panci keliling", gaji: 3400 },
                    { text: "ngelap debu di rak minimarket", gaji: 1700 },
                    { text: "jadi pawang ular sanca", gaji: 7200 },
                    { text: "jualan martabak manis", gaji: 2900 },
                    { text: "jadi fotografer keliling", gaji: 4500 },
                    { text: "nambal jalan berlubang", gaji: 5200 },
                    { text: "jadi agen rahasia (gadungan)", gaji: 8000 },
                    { text: "ngangkut kayu bakar", gaji: 2200 },
                    { text: "bersihin AC kantor", gaji: 6100 },
                    { text: "jadi tukang sol sepatu", gaji: 2700 },
                    { text: "jualan koran di lampu merah", gaji: 900 },
                    { text: "jadi instruktur senam", gaji: 4300 },
                    { text: "nyuci sepatu branded", gaji: 3600 },
                    { text: "jadi operator warnet", gaji: 2400 },
                    { text: "bersihin toilet umum", gaji: 4000 },
                    { text: "jadi MC acara sunatan", gaji: 5500 },
                    { text: "jualan tahu bulat digoreng dadakan", gaji: 1800 },
                    { text: "jadi asisten tukang sate", gaji: 2500 },
                    { text: "ngitungin kendaraan lewat", gaji: 300 },
                    { text: "jadi penunggu gudang angker", gaji: 8800 },
                    { text: "nyuci karpet masjid", gaji: 3500 },
                    { text: "jadi penjahit permak jeans", gaji: 4100 },
                    { text: "jualan kembang api", gaji: 2300 },
                    { text: "jadi pemandu wisata lokal", gaji: 4900 },
                    { text: "ngelap sepatu bot polisi", gaji: 2000 },
                    { text: "jadi koki nasi goreng", gaji: 3800 },
                    { text: "nyari belut di sawah", gaji: 3200 },
                    { text: "jadi tukang gali kubur", gaji: 7500 },
                    { text: "jualan aromanis", gaji: 1400 },
                    { text: "jadi tester pedas seblak", gaji: 2200 },
                    { text: "bersihin lumut di kolam", gaji: 2900 },
                    { text: "jadi tukang jahit sepatu", gaji: 2600 },
                    { text: "ngantar galon aqua", gaji: 3400 },
                    { text: "jadi penaga pintu perlintasan kereta", gaji: 5800 },
                    { text: "nyapu jalanan kota", gaji: 4200 },
                    { text: "jadi pelatih lari (dikejar anjing)", gaji: 1500 },
                    { text: "jualan jas hujan plastik", gaji: 1200 },
                    { text: "jadi pengumpul barang rongsok", gaji: 2800 },
                    { text: "bersihin kaca jendela rumah", gaji: 1900 },
                    { text: "jadi tukang gali sumur", gaji: 9200 },
                    { text: "nyuci motor tetangga", gaji: 2500 },
                    { text: "jadi sales asuransi", gaji: 5000 },
                    { text: "jualan mainan anak-anak", gaji: 2100 },
                    { text: "jadi tukang las karbit", gaji: 4700 },
                    { text: "ngelonin kucing garong", gaji: 500 },
                    { text: "jadi pelayan kafe", gaji: 3300 },
                    { text: "bersihin taman kota", gaji: 3900 },
                    { text: "jadi tukang patri", gaji: 1800 },
                    { text: "jualan kopi starling", gaji: 2600 },
                    { text: "jadi kurir makanan cepat saji", gaji: 3700 },
                    { text: "nyuci helm motor", gaji: 1600 },
                    { text: "jadi tukang sapu pasar", gaji: 2400 },
                    { text: "ngangkut beras sekarung", gaji: 3000 },
                    { text: "jadi pemeran hantu pocong", gaji: 5500 },
                    { text: "bersihin aquarium raksasa", gaji: 7800 },
                    { text: "jadi admin sosmed olshop", gaji: 4500 },
                    { text: "nangkepin jangkrik di kebun", gaji: 1200 }
                ];
